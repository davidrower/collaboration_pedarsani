				...
				if (car in settings.platoonedvehicles):	
					...
					if (traci.vehicle.getColor(car) == (0,255,255,0)):
						...
						if leading_temp:
							...
							if ("CarCACC" in type_alt) and (not platoon_alt): # no, the leading vehicle is not in a platoon, but it could be
							...
							if ("CarCACC" in type_alt) and (platoon_alt): # yes, the leading vehicle IS in a platoon, so we can merge
